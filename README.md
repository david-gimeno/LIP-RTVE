...
- [**src/transcriptions/ :**]() Folder where text transcriptions for each LIP-RTVE sample are available in one-line txt files.
...
<p>
  ...
  <img src="https://progress-bar.dev/0/?width=150&title=Processed transcriptions: " /><br>
</p>
